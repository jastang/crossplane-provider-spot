...
PROJECT_NAME := provider-spot
PROJECT_REPO := github.com/spot/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION := 1.123.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-spotinst
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-spotinst_v1.123.0_x5
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/spotinst/terraform-provider-spotinst/releases/download/v1.123.0
...
xpkg.build.provider-spot: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/spots/01-delete.yaml.tmpl.
